...
-- ----------------------------
-- Table structure for `t_act_actprocesstype`
-- ----------------------------
DROP TABLE IF EXISTS `t_act_actprocesstype`;
CREATE TABLE `t_act_actprocesstype` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `UK_5s1lka55hlq46e3l3wrhuuyse` (`code`),
  UNIQUE KEY `UK_m9g87ma4mbx50tsyfctrf7123` (`name`),
  KEY `FK_oh4tuqk4vaesr9bpbj70h54ws` (`group_code`),
  CONSTRAINT `FK_oh4tuqk4vaesr9bpbj70h54ws` FOREIGN KEY (`group_code`) REFERENCES `t_act_actprocesstype` (`code`)
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of t_act_actprocesstype
-- ----------------------------
INSERT INTO `t_act_actprocesstype` VALUES ('1', '2016-10-31 17:10:46', 'admin', '1', null, null, '0', 'FinaceActProcessType', '财务管理类', '1', null, null);
INSERT INTO `t_act_actprocesstype` VALUES ('2', '2016-10-31 17:10:46', 'admin', '1', null, null, '0', 'ExecActProcessType', '行政管理类', '2', null, null);
INSERT INTO `t_act_actprocesstype` VALUES ('3', '2016-10-31 17:10:47', 'admin', '1', null, null, '0', 'BusActProcessType', '业务管理类', '3', null, null);
INSERT INTO `t_act_actprocesstype` VALUES ('4', '2016-10-31 17:10:47', 'admin', '1', null, null, '0', 'WareHouseActProcessType', '仓管类别', '4', null, null);
INSERT INTO `t_act_actprocesstype` VALUES ('5', '2016-10-31 17:10:47', 'admin', '1', null, null, '0', 'OtherActProcessType', '其他类别', '5', null, null);

-- ----------------------------
-- Table structure for `t_act_act_process_type`
-- ----------------------------
DROP TABLE IF EXISTS `t_act_act_process_type`;
CREATE TABLE `t_act_act_process_type` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `create_time` datetime DEFAULT NULL,
  `create_user` varchar(36) DEFAULT NULL,
  `status` int(11) DEFAULT NULL,
  ...
  `group_code` varchar(36) DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `UK_ky8crgb3xp8pi8y1u53iw78vh` (`code`),
  UNIQUE KEY `UK_v7wobvps7lyx0s76jp43h2q2` (`name`),
  KEY `FK_fpxevi6iqg5n2tiym2djwghne` (`group_code`),
  CONSTRAINT `FK_fpxevi6iqg5n2tiym2djwghne` FOREIGN KEY (`group_code`) REFERENCES `t_act_act_process_type` (`code`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of t_act_act_process_type
-- ----------------------------
...
-- ----------------------------
INSERT INTO `t_disk_file` VALUES ('2', '2016-09-27 19:44:59', 'admin', '0', '2016-09-27 19:44:59', 'admin', '0', '1_3739306564346434373134333465353636316161303564383964366365303836', '2016\\system\\userphoto\\1\\09\\_3863396339316364656636346663623136613764323463373938356433383539_Penguins.jpg1_3739306564346434373134333465353636316161303564383964366365303836', '777835', 'jpg', '4', null, 'Penguins.jpg', null, null, '1', '2');
...
-- ----------------------------
INSERT INTO `t_disk_folder` VALUES ('2', '2016-09-27 19:44:59', 'admin', '0', '2016-09-27 19:44:59', 'admin', '0', 'userphoto', '1', null, null, null, null, null, null, null, null, '1');
...
INSERT INTO `t_sys_log` VALUES ('171', '2016-09-27 16:10:42', 'admin', '0', '2016-09-27 16:10:42', 'admin', '0', '[admin]用户登录', '0', 'Firefox', '0:0:0:0:0:0:0:1', 'admin', 'LoginController-login', '2016-09-27 16:10:42', null, '0');
INSERT INTO `t_sys_log` VALUES ('172', '2016-09-27 17:14:38', 'admin', '0', '2016-09-27 17:14:38', 'admin', '0', '[admin]用户登录', '0', 'Firefox', '0:0:0:0:0:0:0:1', 'admin', 'LoginController-login', '2016-09-27 17:14:38', null, '0');
INSERT INTO `t_sys_log` VALUES ('173', '2016-09-27 19:48:38', 'admin', '0', '2016-09-27 19:48:38', 'admin', '0', '[admin]用户注销', '0', 'Firefox', '0:0:0:0:0:0:0:1', 'admin', 'LoginController-logout', '2016-09-27 19:48:38', null, '0');
INSERT INTO `t_sys_log` VALUES ('174', '2016-09-27 19:51:15', 'admin', '0', '2016-09-27 19:51:15', 'admin', '0', '[admin]用户登录', '0', 'Firefox', '0:0:0:0:0:0:0:1', 'admin', 'LoginController-login', '2016-09-27 19:51:15', null, '0');
INSERT INTO `t_sys_log` VALUES ('175', '2016-09-27 19:51:45', 'admin', '0', '2016-09-27 19:51:45', 'admin', '0', '[admin]用户登录', '0', 'Firefox', '0:0:0:0:0:0:0:1', 'admin', 'LoginController-login', '2016-09-27 19:51:45', null, '0');
INSERT INTO `t_sys_log` VALUES ('176', '2016-09-27 19:52:01', 'admin', '0', '2016-09-27 19:52:01', 'admin', '0', '[admin]用户登录', '0', 'Firefox', '0:0:0:0:0:0:0:1', 'admin', 'LoginController-login', '2016-09-27 19:52:01', null, '0');
INSERT INTO `t_sys_log` VALUES ('177', '2016-09-27 19:52:12', 'admin', '0', '2016-09-27 19:52:12', 'admin', '0', '[admin]用户登录', '0', 'Firefox', '0:0:0:0:0:0:0:1', 'admin', 'LoginController-login', '2016-09-27 19:52:12', null, '0');
INSERT INTO `t_sys_log` VALUES ('178', '2016-09-27 19:52:29', 'finace', '0', '2016-09-27 19:52:29', 'finace', '0', '[finace]用户登录', '0', 'Firefox', '0:0:0:0:0:0:0:1', 'finace', 'LoginController-login', '2016-09-27 19:52:29', null, '0');
INSERT INTO `t_sys_log` VALUES ('179', '2016-09-27 19:55:49', 'finace', '0', '2016-09-27 19:55:49', 'finace', '0', '[finace]用户注销', '0', 'Firefox', '0:0:0:0:0:0:0:1', 'finace', 'LoginController-logout', '2016-09-27 19:55:49', null, '0');
INSERT INTO `t_sys_log` VALUES ('180', '2016-09-27 19:56:00', 'admin', '0', '2016-09-27 19:56:00', 'admin', '0', '[admin]用户登录', '0', 'Firefox', '0:0:0:0:0:0:0:1', 'admin', 'LoginController-login', '2016-09-27 19:56:00', null, '0');
INSERT INTO `t_sys_log` VALUES ('181', '2016-09-30 10:39:13', 'admin', '0', '2016-09-30 10:39:13', 'admin', '0', '[admin]用户登录', '0', 'Firefox', '0:0:0:0:0:0:0:1', 'admin', 'LoginController-login', '2016-09-30 10:39:13', null, '0');
INSERT INTO `t_sys_log` VALUES ('182', '2016-10-09 17:27:22', 'admin', '0', '2016-10-09 17:27:22', 'admin', '0', '[admin]用户登录', '0', 'Firefox', '0:0:0:0:0:0:0:1', 'admin', 'LoginController-login', '2016-10-09 17:27:22', null, '0');
INSERT INTO `t_sys_log` VALUES ('183', '2016-10-28 11:56:11', 'admin', '0', '2016-10-28 11:56:11', 'admin', '0', '[admin]用户登录', '0', 'Chrome', '0:0:0:0:0:0:0:1', 'admin', 'LoginController-login', '2016-10-28 11:56:11', null, '0');
INSERT INTO `t_sys_log` VALUES ('184', '2016-10-28 12:00:40', 'admin', '0', '2016-10-28 12:00:40', 'admin', '0', '[admin]用户注销', '0', 'Chrome', '0:0:0:0:0:0:0:1', 'admin', 'LoginController-logout', '2016-10-28 12:00:40', null, '0');
INSERT INTO `t_sys_log` VALUES ('185', '2016-10-28 12:00:46', 'admin', '0', '2016-10-28 12:00:46', 'admin', '0', '[admin]用户登录', '0', 'Chrome', '0:0:0:0:0:0:0:1', 'admin', 'LoginController-login', '2016-10-28 12:00:46', null, '0');
INSERT INTO `t_sys_log` VALUES ('186', '2016-10-28 13:13:48', 'admin', '0', '2016-10-28 13:13:48', 'admin', '0', '[admin]用户登录', '0', 'Chrome', '0:0:0:0:0:0:0:1', 'admin', 'LoginController-login', '2016-10-28 13:13:48', null, '0');
INSERT INTO `t_sys_log` VALUES ('187', '2016-10-28 15:38:40', 'admin', '0', '2016-10-28 15:38:40', 'admin', '0', '[admin]用户登录', '0', 'Chrome', '0:0:0:0:0:0:0:1', 'admin', 'LoginController-login', '2016-10-28 15:38:40', null, '0');
INSERT INTO `t_sys_log` VALUES ('188', '2016-10-28 15:42:47', 'admin', '0', '2016-10-28 15:42:47', 'admin', '0', '[admin]用户注销', '0', 'Chrome', '0:0:0:0:0:0:0:1', 'admin', 'LoginController-logout', '2016-10-28 15:42:47', null, '0');
INSERT INTO `t_sys_log` VALUES ('189', '2016-10-28 15:42:52', 'admin', '0', '2016-10-28 15:42:52', 'admin', '0', '[admin]用户登录', '0', 'Chrome', '0:0:0:0:0:0:0:1', 'admin', 'LoginController-login', '2016-10-28 15:42:52', null, '0');
INSERT INTO `t_sys_log` VALUES ('190', '2016-10-28 15:51:50', 'admin', '0', '2016-10-28 15:51:50', 'admin', '0', '[admin]用户登录', '0', 'Chrome', '0:0:0:0:0:0:0:1', 'admin', 'LoginController-login', '2016-10-28 15:51:50', null, '0');
INSERT INTO `t_sys_log` VALUES ('191', '2016-10-31 17:07:20', 'admin', '0', '2016-10-31 17:07:20', 'admin', '0', '[admin]用户登录', '0', 'Chrome', '0:0:0:0:0:0:0:1', 'admin', 'LoginController-login', '2016-10-31 17:07:20', null, '0');
INSERT INTO `t_sys_log` VALUES ('192', '2016-10-31 17:11:36', 'admin', '0', '2016-10-31 17:11:36', 'admin', '0', '[admin]用户登录', '0', 'Chrome', '0:0:0:0:0:0:0:1', 'admin', 'LoginController-login', '2016-10-31 17:11:36', null, '0');
...
INSERT INTO `t_sys_resource` VALUES ('33', '2016-10-28 11:59:27', 'admin', '0', '2016-10-28 11:59:27', 'admin', '0', '', null, 'eu-icon-application', '', '流程设置', '20', '0', '', '1');
INSERT INTO `t_sys_resource` VALUES ('34', '2016-10-28 11:59:57', 'admin', '0', '2016-10-28 15:39:40', 'admin', '1', '', null, '', '', '流程分类', '21', '0', 'act/actprocesstype', '33');
INSERT INTO `t_sys_resource` VALUES ('35', '2016-10-28 15:40:29', 'admin', '0', '2016-10-28 15:40:29', 'admin', '0', '', null, '', '', '流程部署', '22', '0', 'act/actprocessdeploy', '33');
INSERT INTO `t_sys_resource` VALUES ('36', '2016-10-28 15:41:02', 'admin', '0', '2016-10-28 15:41:02', 'admin', '0', '', null, '', '', '流程定义', '23', '0', 'act/actprocessdef', '33');
INSERT INTO `t_sys_resource` VALUES ('37', '2016-10-28 15:42:32', 'admin', '0', '2016-10-28 15:42:32', 'admin', '0', '', null, '', '', '流程表单', '24', '0', 'act/actprocessform', '33');
...
-- ----------------------------
INSERT INTO `t_sys_role` VALUES ('2', '2016-09-27 19:42:06', 'admin', '0', '2016-09-27 19:42:06', 'admin', '0', 'StoreManager', '仓库管理员', '仓库管理员');
INSERT INTO `t_sys_role` VALUES ('3', '2016-09-27 19:42:48', 'admin', '0', '2016-09-27 19:43:58', 'admin', '1', 'FinaceAdmin', '财务管理员', '财务管理员');
...
-- ----------------------------
INSERT INTO `t_sys_role_resource` VALUES ('3', '31');
INSERT INTO `t_sys_role_resource` VALUES ('3', '32');
...
INSERT INTO `t_sys_user` VALUES ('5', '2016-09-27 19:46:28', 'admin', '0', '2016-09-27 19:48:26', 'admin', '3', '上海市浦东新区北艾路1660弄', null, 'finace', '13764026448', '财务管理', 'b330f3eefd739fb873f10f22cd5ac730', '1', null, '3', '2016-09-26 00:00:00', '1', '/a/disk/file/2', '');
...
INSERT INTO `t_sys_user_organ` VALUES ('5', '1');
INSERT INTO `t_sys_user_organ` VALUES ('5', '2');
INSERT INTO `t_sys_user_organ` VALUES ('5', '3');
...
-- ----------------------------
INSERT INTO `t_sys_user_post` VALUES ('5', '1');
...
-- ----------------------------
INSERT INTO `t_sys_user_role` VALUES ('5', '3');
